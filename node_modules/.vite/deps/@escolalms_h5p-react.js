...
// node_modules/@escolalms/h5p-react/lib/components/hh5p/context/index.js
var require_context = __commonJS({
  "node_modules/@escolalms/h5p-react/lib/components/hh5p/context/index.js"(exports) {
    "use strict";
    ...
    var EditorContextProvider = function(_a) {
      ...
      var getEditorConfig = (0, react_1.useCallback)(function(id) {
        ...
        return fetch(furl, {
          ...
          setState(function(prevState) {
            return __assign(__assign({}, prevState), { value: "loaded", settings: data.data });
          });
          return data;
        }).catch(function(err) {
          setState(function(prevState) {
            return __assign(__assign({}, prevState), { value: "error", error: err.toString() });
          });
        });
      }, [url, headers, lang]);
      var seth5pObject = (0, react_1.useCallback)(function(h5pObject) {
        if (h5pObject) {
          setState(function(prevState) {
            return __assign(__assign({}, prevState), { value: "loaded", settings: h5pObject });
          });
        }
      }, [url, headers]);
...
var require_cjs = __commonJS({
  "node_modules/html-escaper/cjs/index.js"(exports) {
    "use strict";
    var { replace } = "";
...
// node_modules/@escolalms/h5p-react/lib/components/hh5p/loader.js
var require_loader = __commonJS({
  "node_modules/@escolalms/h5p-react/lib/components/hh5p/loader.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
// node_modules/@escolalms/h5p-react/lib/components/hh5p/editor/index.js
var require_editor = __commonJS({
  "node_modules/@escolalms/h5p-react/lib/components/hh5p/editor/index.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var html_escaper_1 = require_cjs();
    ...
    var Editor = function(_a) {
        ...
        var onMessage = function(event) {
          ...
          if (event.data.h5pEditorStatus) {
            ...
            if (status_1.h5pEditorStatus === "success" && state.value === "loaded") {
              ...
              submitContent && submitContent(__assign(__assign({}, status_1.data), { nonce: state.settings.nonce }), id).then(function(data) {
      ...
      var src = (0, react_1.useMemo)(function() {
        ...
        if (!settings)
          return "";
        var content = state.value === "loaded" && ((_a2 = state.settings) === null || _a2 === void 0 ? void 0 : _a2.contents) ? (_b2 = state.settings) === null || _b2 === void 0 ? void 0 : _b2.contents[Object.keys((_c2 = state.settings) === null || _c2 === void 0 ? void 0 : _c2.contents)[0]] : null;
        ...
        ns.getAjaxUrl = function (action, parameters) {
            ...
            url += action === "files" ? "/`).concat(settings.nonce, '" : "";\n            url += "').concat(settings.token ? "?_token=" + settings.token : "", '";\n            if (parameters !== undefined) {\n                var separator = url.indexOf("?") === -1 ? "?" : "&";\n                for (var property in parameters) {\n                    if (parameters.hasOwnProperty(property)) {\n                        url += separator + property + "=" + parameters[property];\n                        separator = "&";\n                    }\n                }\n            }\n            return url;\n        };\n        $(document).ready(ns.init);\n    })(H5P.jQuery);\n    ');
        var markup = (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)("html", { children: [(0, jsx_runtime_1.jsxs)("head", { children: [(0, jsx_runtime_1.jsx)("style", { children: " body, html {margin:0; padding:0;}" }), (0, jsx_runtime_1.jsx)("script", { dangerouslySetInnerHTML: {
          __html: "const H5PIntegration = window.H5PIntegration = ".concat(JSON.stringify(settings), "; ")
        } }), settings.core.scripts.map(function(script) {
          return (0, jsx_runtime_1.jsx)("script", { src: script }, script);
        }), settings.core.styles.map(function(style) {
          return (0, jsx_runtime_1.jsx)("link", { type: "text/css", rel: "stylesheet", href: style }, style);
        })] }), (0, jsx_runtime_1.jsx)("body", { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-editor-wrapper" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ id: "h5p-editor", className: "height-observer" }, { children: "loading" })), (0, jsx_runtime_1.jsx)("p", {}), (0, jsx_runtime_1.jsx)("button", __assign({ className: "h5p-core-button", id: "h5p-editor-submit" }, { children: "submit data" })), (0, jsx_runtime_1.jsx)("script", { dangerouslySetInnerHTML: { __html: scriptInline } })] })) })] }));
        var pMarkup = prepareMarkupForPassing(markup);
        return window.URL.createObjectURL(new Blob([pMarkup], {
          type: "text/html"
        }));
      }, [state]);
      return (0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-editor", style: { height, position: "relative" } }, { children: [editorState.state === "loading" && (0, jsx_runtime_1.jsx)(loader_1.default, {}), editorState.state === "error" && (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("pre", { children: "Error:" }), " ", editorState.error] }), src && (0, jsx_runtime_1.jsx)("iframe", { ref: iFrameRef, title: "editor", src, style: {
        width: "100%",
        height: "100%",
        margin: 0,
        padding: 0,
...
// node_modules/@escolalms/h5p-react/lib/components/hh5p/player/index.js
var require_player = __commonJS({
  "node_modules/@escolalms/h5p-react/lib/components/hh5p/player/index.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var Player = function(_a) {
      ...
      var src = (0, react_1.useMemo)(function() {
        ...
        var markup = (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)("html", { children: [(0, jsx_runtime_1.jsxs)("head", { children: [(0, jsx_runtime_1.jsx)("style", { children: "\n          body, html {margin:0; padding:0;}\n          iframe { border:none; margin:0; padding:0; }\n          " }), (0, jsx_runtime_1.jsx)("script", { children: "const H5PIntegration = window.H5PIntegration = ".concat(JSON.stringify(settings), "; ") }), __spreadArray(__spreadArray([], settings.core.scripts, true), settings.loadedJs, true).map(function(script) {
          return (0, jsx_runtime_1.jsx)("script", { src: script }, script);
        }), __spreadArray(__spreadArray([], settings.core.styles, true), settings.loadedCss, true).map(function(style) {
          return (0, jsx_runtime_1.jsx)("link", { type: "text/css", rel: "stylesheet", href: style }, style);
        }), (0, jsx_runtime_1.jsx)("script", { children: 'H5P.getCrossOrigin = function (source) { return "anonymous" }' })] }), (0, jsx_runtime_1.jsx)("body", { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-player-wrapper h5p-resize-observer" }, { children: [embedType && embedType === "div" || embedType === "" && (0, jsx_runtime_1.jsx)("div", { className: "h5p-content", "data-content-id": id }), embedType && embedType === "iframe" && (0, jsx_runtime_1.jsx)("div", __assign({ className: "h5p-iframe-wrapper" }, { children: (0, jsx_runtime_1.jsx)("iframe", { id: "h5p-iframe-".concat(id), className: "h5p-iframe", "data-content-id": id, src: "about:blank", frameBorder: "0", scrolling: "no", title: "player" }) })), (0, jsx_runtime_1.jsx)("script", { children: '\n            (function ($) {\n                const replacerFunc = () => {\n                    const visited = new WeakSet();\n                    return (key, value) => {\n                      if (value.nodeType) return;\n                      if (typeof value === "object" && value !== null) {\n                        if (visited.has(value)) {\n                          return;\n                        }\n                        visited.add(value);\n                      }\n                      return value;\n                    };\n                  };\n                const postMessage = (data) => parent.postMessage(data, "'.concat(window.location.origin, `");
                const resizeObserver = new ResizeObserver((entries) =>
                    postMessage({ iFrameHeight: entries[0].contentRect.height })
                );
      ...
      return (0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-player", style: {
        ...
        alignContent: "center",
        flexDirection: "row"
      } }, { children: [loading && (0, jsx_runtime_1.jsx)(loader_1.default, {}), !loading && (0, jsx_runtime_1.jsx)("iframe", { ref: iFrameRef, title: "player", src, style: {
        display: "block",
        border: "none",
        flexGrow: 1,
        flexShrink: 1,
...
// node_modules/@escolalms/h5p-react/lib/components/hh5p/contextless/editor.js
var require_editor2 = __commonJS({
  "node_modules/@escolalms/h5p-react/lib/components/hh5p/contextless/editor.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var Editor = function(_a) {
      var id = _a.id, onSubmit = _a.onSubmit, state = _a.state, _b = _a.allowSameOrigin, allowSameOrigin = _b === void 0 ? false : _b, onError = _a.onError, _c = _a.loading, loading = _c === void 0 ? false : _c;
        ...
        var onMessage = function(event) {
          ...
          if (event.data.h5pEditorStatus) {
            ...
            if (status_1.h5pEditorStatus === "success") {
              onSubmit && onSubmit(__assign(__assign({}, status_1.data), { nonce: state.nonce }), id);
            }
      ...
      var src = (0, react_1.useMemo)(function() {
        ...
        if (!settings)
          return "";
        var content = state.contents ? state === null || state === void 0 ? void 0 : state.contents[Object.keys(state.contents)[0]] : null;
        var params = content ? content.jsonContent : "";
        try {
          params && JSON.parse(params);
        } catch (er) {
      ...
      return (0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-editor", style: { height, position: "relative" } }, { children: [loading && (0, jsx_runtime_1.jsx)(loader_1.default, {}), src && (0, jsx_runtime_1.jsx)("iframe", {
        ref: iFrameRef,
        title: "editor",
        src,
        style: {
...
// node_modules/@escolalms/h5p-react/lib/components/hh5p/contextless/player.js
var require_player2 = __commonJS({
  "node_modules/@escolalms/h5p-react/lib/components/hh5p/contextless/player.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var lodash_throttle_1 = __importDefault(require_lodash());
    var Player = function(_a) {
      var onXAPI = _a.onXAPI, state = _a.state, _b = _a.styles, styles = _b === void 0 ? [] : _b;
      var _c = (0, react_1.useState)(100), height = _c[0], setHeight = _c[1];
      var iFrameRef = (0, react_1.useRef)(null);
      var contentId = (0, react_1.useMemo)(function() {
        var content = (state === null || state === void 0 ? void 0 : state.contents) ? state === null || state === void 0 ? void 0 : state.contents[Object.keys(state === null || state === void 0 ? void 0 : state.contents)[0]] : null;
        if (content) {
      ...
      var src = (0, react_1.useMemo)(function() {
        ...
        if (!settings)
          return "";
        var content = (settings === null || settings === void 0 ? void 0 : settings.contents) ? settings === null || settings === void 0 ? void 0 : settings.contents[Object.keys(settings === null || settings === void 0 ? void 0 : settings.contents)[0]] : null;
        settings.core.styles = settings.core.styles.concat(styles);
        var embedType = content === null || content === void 0 ? void 0 : content.content.library.embedTypes;
        var markup = (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)("html", { children: [(0, jsx_runtime_1.jsxs)("head", { children: [(0, jsx_runtime_1.jsx)("style", { children: "\n            body, html {margin:0; padding:0;}\n            iframe { border:none; margin:0; padding:0; }\n            " }), (0, jsx_runtime_1.jsx)("script", { children: "const H5PIntegration = window.H5PIntegration = ".concat(JSON.stringify(settings), "; ") }), __spreadArray(__spreadArray([], settings.core.scripts, true), settings.loadedJs, true).map(function(script) {
          return (0, jsx_runtime_1.jsx)("script", { src: script }, script);
          ...
          return (0, jsx_runtime_1.jsx)("link", { type: "text/css", rel: "stylesheet", href: style }, style);
        }), (0, jsx_runtime_1.jsx)("script", { children: 'H5P.getCrossOrigin = function (source) { return "anonymous" }' })] }), (0, jsx_runtime_1.jsx)("body", { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-player-wrapper h5p-resize-observer" }, { children: [embedType && embedType === "div" || embedType === "" && (0, jsx_runtime_1.jsx)("div", { className: "h5p-content", "data-content-id": contentId }), embedType && embedType === "iframe" && (0, jsx_runtime_1.jsx)("div", __assign({ className: "h5p-iframe-wrapper" }, { children: (0, jsx_runtime_1.jsx)("iframe", { id: "h5p-iframe-".concat(contentId), className: "h5p-iframe", "data-content-id": contentId, src: "about:blank", frameBorder: "0", scrolling: "no", title: "player" }) })), (0, jsx_runtime_1.jsx)("script", { children: '\n              (function ($) {\n                  const replacerFunc = () => {\n                      const visited = new WeakSet();\n                      return (key, value) => {\n                        if (value.nodeType) return;\n                        if (typeof value === "object" && value !== null) {\n                          if (visited.has(value)) {\n                            return;\n                          }\n                          visited.add(value);\n                        }\n                        return value;\n                      };\n                    };\n                  const postMessage = (data) => parent.postMessage(data, "'.concat(window.location.origin, `");
                  const resizeObserver = new ResizeObserver((entries) =>
                      postMessage({ iFrameHeight: entries[0].contentRect.height })
                  );
                  resizeObserver.observe(document.querySelector(".h5p-resize-observer"));
...
// node_modules/@escolalms/h5p-react/lib/index.js
var require_lib = __commonJS({
  "node_modules/@escolalms/h5p-react/lib/index.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ContextlessPlayer = exports.ContextlessEditor = exports.Player = exports.Editor = exports.EditorContext = exports.EditorContextProvider = void 0;
    var index_1 = require_context();
    Object.defineProperty(exports, "EditorContextProvider", { enumerable: true, get: function() {
      return index_1.EditorContextProvider;
    } });
    Object.defineProperty(exports, "EditorContext", { enumerable: true, get: function() {
      return index_1.EditorContext;
    } });
    var index_2 = __importDefault(require_editor());
    exports.Editor = index_2.default;
    var player_1 = __importDefault(require_player());
    exports.Player = player_1.default;
    var editor_1 = __importDefault(require_editor2());
    exports.ContextlessEditor = editor_1.default;
    var player_2 = __importDefault(require_player2());
    exports.ContextlessPlayer = player_2.default;
    exports.default = {
      ...
      ContextlessEditor: editor_1.default,
      ContextlessPlayer: player_2.default
    };
  }
});

// dep:@escolalms_h5p-react
var escolalms_h5p_react_default = require_lib();
export {
  escolalms_h5p_react_default as default
};
/**
 * @license React
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=@escolalms_h5p-react.js.map
