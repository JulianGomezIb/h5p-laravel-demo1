...
var Editor = function (_a) {
    ...
    var src = (0, react_1.useMemo)(function () {
        ...
        var markup = (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)("html", { children: [(0, jsx_runtime_1.jsxs)("head", { children: [(0, jsx_runtime_1.jsx)("style", { children: " body, html {margin:0; padding:0;}" }), (0, jsx_runtime_1.jsx)("script", { dangerouslySetInnerHTML: {
                            ...
                            } }), settings.core.scripts.map(function (script) { return ((0, jsx_runtime_1.jsx)("script", { src: script }, script)); }), settings.core.styles.map(function (style) { return ((0, jsx_runtime_1.jsx)("link", { type: "text/css", rel: "stylesheet", href: style }, style)); })] }), (0, jsx_runtime_1.jsx)("body", { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-editor-wrapper" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ id: "h5p-editor", className: "height-observer" }, { children: "loading" })), (0, jsx_runtime_1.jsx)("p", {}), (0, jsx_runtime_1.jsx)("button", __assign({ className: "h5p-core-button", id: "h5p-editor-submit" }, { children: "submit data" })), (0, jsx_runtime_1.jsx)("script", { dangerouslySetInnerHTML: { __html: scriptInline } })] })) })] }));
        var pMarkup = prepareMarkupForPassing(markup);
        return window.URL.createObjectURL(new Blob([pMarkup], {
            type: "text/html",
        }));
    }, [state]);
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-editor", style: { height: height, position: "relative" } }, { children: [loading && (0, jsx_runtime_1.jsx)(loader_1.default, {}), src && ((0, jsx_runtime_1.jsx)("iframe", { ref: iFrameRef, title: "editor", src: src, 
                // TODO test this
                //srcDoc={src}
                style: {
                    width: "100%",
